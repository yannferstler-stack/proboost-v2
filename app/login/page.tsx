  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'Inter, sans-serif' }}>
        ...
        <div style={{
          flex: 1,
          background: 'linear-gradient(145deg, #0d0620 0%, #1a0533 30%, #0f0a2e 60%, #1a0320 100%)',
          display: 'flex', flexDirection: 'column', justifyContent: 'space-between',
          padding: '40px 48px', position: 'relative', overflow: 'hidden'
        }}>
          {/* Orbes */}
          <div className="orb-anim" style={{ position: 'absolute', top: '5%', left: '20%', width: 500, height: 500, background: 'radial-gradient(circle, rgba(168,85,247,0.35) 0%, rgba(236,72,153,0.15) 45%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none', filter: 'blur(2px)' }} />
          <div className="orb-anim-b" style={{ position: 'absolute', bottom: '-10%', right: '5%', width: 380, height: 380, background: 'radial-gradient(circle, rgba(239,68,68,0.25) 0%, rgba(234,179,8,0.10) 50%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none', filter: 'blur(2px)' }} />
          <div style={{ position: 'absolute', top: '40%', left: '-5%', width: 280, height: 280, background: 'radial-gradient(circle, rgba(59,130,246,0.20) 0%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none' }} />
          {/* Grille */}
          ...
          {/* Logo */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer', position: 'relative', zIndex: 1 }} onClick={() => window.location.href = '/'}>
          ...
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.2)', position: 'relative', zIndex: 1 }}>© 2025 ProBoost</p>
        </div>

        {/* RIGHT — Formulaire */}
        <div style={{ width: 500, background: '#0d0620', borderLeft: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 56px' }}>
          <div style={{ width: '100%', animation: 'fadeUp 0.5s ease both' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <p style={{ textAlign: 'center', fontSize: 14, color: 'rgba(255,255,255,0.4)' }}>
                ...
                <span onClick={() => {
                  if (isSignUp) { setIsSignUp(false); setMessage('') }
                  else window.location.href = '/souscrire'
