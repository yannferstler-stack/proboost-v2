    ...
    <>
      ...
      <div style={{ fontFamily: 'Inter, sans-serif', color: 'white', background: '#0d0620' }}>
        ...
        <nav style={{
          ...
          padding: '0 40px',
          background: scrollY > 20 ? 'rgba(13,6,32,0.92)' : 'transparent',
        ...
        <section style={{ minHeight: '100vh', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
          ...
          {/* Contenu centré */}
          <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '0 24px', maxWidth: 900, width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>

            {/* Badge */}
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(168,85,247,0.15)', border: '1px solid rgba(168,85,247,0.30)', borderRadius: 20, padding: '6px 16px', marginBottom: 28 }}>
              <div style={{ width: 6, height: 6, background: '#a855f7', borderRadius: '50%', animation: 'pulse 2s infinite' }} />
              <span style={{ fontSize: 12, color: '#c084fc', fontWeight: 600 }}>Recouvrement automatisé · Dès 19,99 €/mois</span>
            </div>

            {/* Titre 2 lignes */}
            <h1 style={{ marginBottom: 20, textShadow: '0 2px 24px rgba(0,0,0,0.6)', lineHeight: 1.1 }}>
              <span style={{ display: 'block', fontFamily: 'Manrope', fontWeight: 400, fontSize: 'clamp(32px, 4.5vw, 58px)', color: 'white', letterSpacing: '-0.5px' }}>
                Concentrez-vous sur l&apos;essentiel,
              </span>
              <span style={{ display: 'block', fontFamily: 'Playfair Display', fontWeight: 700, fontStyle: 'italic', fontSize: 'clamp(32px, 4.5vw, 58px)', color: 'white', letterSpacing: '-0.5px' }}>
                nous gérons vos impayés.
              </span>
            </h1>

            {/* Sous-titre */}
            <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.75)', marginBottom: 36, fontWeight: 300, textShadow: '0 1px 8px rgba(0,0,0,0.5)', maxWidth: 520 }}>
              Nous vous aidons à piloter votre trésorerie en toute simplicité.
            </p>

            {/* Boutons */}
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', alignItems: 'center', marginBottom: 36, flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', gap: 24, justifyContent: 'center', flexWrap: 'wrap' }}>
              {['Dès 19,99 €/mois', 'Commission au succès', 'Email + SMS'].map((t, i) => (
                <span key={i} style={{ fontSize: 13, color: 'rgba(255,255,255,0.55)', display: 'flex', alignItems: 'center', gap: 5 }}>
        ...
        {/* STATS */}
        <section style={{ background: 'rgba(255,255,255,0.03)', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '80px 40px' }}>
          <Reveal>
            <p style={{ textAlign: 'center', fontSize: 11, color: 'rgba(255,255,255,0.25)', fontWeight: 600, letterSpacing: '3px', textTransform: 'uppercase', marginBottom: 56 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 0, maxWidth: 960, margin: '0 auto' }}>
            {[
              ...
              <Reveal key={i} delay={i * 0.1}>
                <div style={{ padding: '40px 36px', borderRight: i < 2 ? '1px solid rgba(255,255,255,0.06)' : 'none', textAlign: 'center' }}>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, justifyContent: 'center', marginBottom: 16 }}>
                    <span style={{ fontFamily: 'Manrope', fontWeight: 900, fontSize: 72, color: s.color, letterSpacing: '-3px', lineHeight: 1 }}>{s.value}</span>
                    <span style={{ fontFamily: 'Manrope', fontWeight: 700, fontSize: 28, color: s.color, opacity: 0.7 }}>{s.unit}</span>
                  </div>
        ...
        <section style={{ padding: '48px 40px 0' }}>
          <Reveal>
            <div style={{ maxWidth: 960, margin: '0 auto', background: 'rgba(168,85,247,0.08)', border: '1px solid rgba(168,85,247,0.20)', borderRadius: 20, padding: '28px 36px', display: 'flex', alignItems: 'center', gap: 24 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                  ...
                  <span style={{ fontSize: 13, color: '#c084fc', fontWeight: 600 }}>Facturation électronique obligatoire en France</span>
                </div>
          ...
          <div style={{ maxWidth: 960, margin: '0 auto' }}>
            <Reveal>
              <div style={{ marginBottom: 64, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
                ...
                <h2 style={{ fontFamily: 'Manrope', fontWeight: 900, fontSize: 44, color: 'white', letterSpacing: '-2px', textAlign: 'center' }}>3 étapes pour récupérer vos impayés.</h2>
              </div>
            </Reveal>
            <div className="steps-grid">
              {steps.map((s, i) => (
                <Reveal key={i} delay={i * 0.1}>
                  <div className="step-card" style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: '36px 28px 32px', background: 'rgba(255,255,255,0.04)', backdropFilter: 'blur(12px)', position: 'relative', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ maxWidth: 1060, margin: '0 auto' }}>
            <Reveal>
              <div style={{ textAlign: 'center', marginBottom: 48 }}>
                ...
                <h2 style={{ fontFamily: 'Manrope', fontWeight: 900, fontSize: 38, color: 'white', letterSpacing: '-1.5px', marginBottom: 20 }}>Simple et transparent.</h2>
                <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.50)', lineHeight: 1.8, maxWidth: 640, margin: '0 auto' }}>
              ...
              {PLANS.map((plan, i) => (
                <Reveal key={plan.nom} delay={i * 0.08}>
                  <div className="plan-card"
                    ...
                    style={{ background: plan.popular ? 'rgba(168,85,247,0.10)' : 'rgba(255,255,255,0.04)', backdropFilter: 'blur(12px)', borderRadius: 20, padding: '36px 28px', border: plan.popular ? '1.5px solid rgba(168,85,247,0.40)' : '1px solid rgba(255,255,255,0.08)', boxShadow: plan.popular ? '0 8px 40px rgba(168,85,247,0.20)' : 'none', position: 'relative', display: 'flex', flexDirection: 'column' }}>
                    {plan.popular && (
                    ...
                    <div style={{ marginBottom: 24 }}>
                      ...
                      <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)', marginBottom: 20, lineHeight: 1.5 }}>{plan.description}</p>
                      <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 12 }}>
                        <span style={{ fontFamily: 'Manrope', fontWeight: 900, fontSize: 40, color: 'white' }}>{plan.prix} €</span>
                    ...
                    <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 24, flex: 1, marginBottom: 24 }}>
                      {plan.features.map((f, j) => (
                        <div key={j} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                          <div style={{ width: 22, height: 22, borderRadius: '50%', background: f.ok ? plan.bg : 'rgba(255,255,255,0.04)', border: f.ok ? `1px solid ${plan.border}` : '1px solid rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <span style={{ fontSize: 11, color: f.ok ? plan.couleur : 'rgba(255,255,255,0.2)', fontWeight: 700 }}>{f.ok ? '✓' : '✗'}</span>
                          </div>
                          <span style={{ fontSize: 14, color: f.ok ? 'rgba(255,255,255,0.85)' : 'rgba(255,255,255,0.25)', fontWeight: f.bold ? 700 : 400 }}>{f.label}</span>
                        </div>
                      ))}
                    </div>
        ...
        <section style={{ padding: '100px 40px', borderTop: '1px solid rgba(255,255,255,0.06)', position: 'relative', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 600, height: 600, background: 'radial-gradient(circle, rgba(168,85,247,0.12) 0%, transparent 65%)', borderRadius: '50%', pointerEvents: 'none' }} />
          <Reveal>
            <div style={{ maxWidth: 680, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
              <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.25)', fontWeight: 600, letterSpacing: '3px', textTransform: 'uppercase', marginBottom: 24 }}>Notre engagement</p>
              ...
              <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.45)', lineHeight: 1.8, fontWeight: 300, maxWidth: 560, margin: '0 auto 40px' }}>
                Nous serons votre allié pour la gestion de vos impayés et serons rémunérés uniquement sur les fonds récupérés.
              </p>
              <button className="btn-primary" onClick={() => router.push('/souscrire')} style={{ fontSize: 16, padding: '16px 40px' }}>
